...
{{-- <script>
        ...
        datasets: [
            {
                label: 'Data Points',
                data: [
                    { x: 10, y: 20, r: 5 },   // Data point 1
                    { x: 15, y: 25, r: 10 },  // Data point 2
                    { x: 8, y: 12, r: 8 },    // Data point 3
                    // Tambahkan data point lain sesuai kebutuhan
                ],
    ...
    // Inisialisasi chart
    var bubbleChart = new Chart('bubbleChart', config);
</script> --}}
